...
type
  TRegister = class
  strict private
    FRegisters: TDictionary<string, TClass>;
    FRoutes: TDictionary<string, string>;
    FValidationPipe: IValidationPipe;
  public
    constructor Create;
    destructor Destroy; override;
    procedure Add(const AClass: TClass); overload;
    ...
    function FindRecord(const AKey: string): TClass;
...
begin
  FRegisters := TDictionary<string, TClass>.Create;
...
function TRegister.FindRecord(const AKey: string): TClass;
begin
  Result := nil;
...
procedure TRegister.Add(const AClass: TClass);
begin
